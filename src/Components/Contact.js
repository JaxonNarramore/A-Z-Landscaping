            ...
            <div id='#' class="whole-contact">
                <div class="contact-container">
                    <div className='footer-logo'>
                        ...
                        <div className='icons'>
                            <a href="https://www.facebook.com/atozlandscapeandmaintenance/" target='_blank'>
                                <AiOutlineFacebook className='facebook' />
                            </a>
                            <a href="https://www.instagram.com/a_zlandscape/?igshid=1a6fezg7wyr61" target='_blank'>
                    ...
                    <div className='contact'>
                        ...
                        <a className='email-link' href="mailto: alex.sanchez@a-zlandscape.com">
                            <p>alex.sanchez@a-zlandscape.com</p>
                        </a>
                        <a className='number-link' href="tel:5128189958">
                            <p>512-818-9958</p>
                        </a>
                    </div>
                    <div class="explore">
